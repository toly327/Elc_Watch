...
#define LINE_SLIP_SPEED			(0.2)			//菜单项横向滚动速度【可以是小数，但是最好是1的整数倍或者1的偶数分之一倍】
...
#define PRESS_TIME                      (0.5)    //按下按键视为长按的时间（单位秒）
#define CONTINUE_PRESS_TIME             (1)    //在长按0.8秒之后继续长按的时间（单位秒）
